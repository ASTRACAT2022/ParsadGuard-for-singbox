...
class Node(Base):
    ...
    core_version: Mapped[Optional[str]] = mapped_column(String(32), nullable=True, init=False)
...
class CoreConfig(Base):
    ...
    type: Mapped[CoreType] = mapped_column(SQLEnum(CoreType), default=CoreType.singbox, server_default=CoreType.singbox)
