...
async def update_node_status(
    ...
    Args:
        ...
        core_version (str, optional): The core version string.
        node_version (str, optional): The version of the node software.
...
async def bulk_update_node_status(
    ...
    Args:
        db (AsyncSession): The database session.
        updates (list[dict]): List of updates with keys: node_id, status, message, core_version, node_version.

    Example:
        updates = [
            {"node_id": 1, "status": NodeStatus.connected, "message": "", "core_version": "1.10.3", "node_version": "0.4.0"},
            {"node_id": 2, "status": NodeStatus.error, "message": "Connection failed", "core_version": "", "node_version": ""},
        ]
    """
    if not updates:
        return
    ...
    stmt = (
        ...
        .values(
            ...
            core_version=bindparam("core_version"),
