...
<p align="center">
    <strong>统一且抗审查的代理管理解决方案 — sing-box 版本</strong>
</p>
...
PasarGuard 是一个强大的代理管理工具，为处理数百个代理账户提供直观高效的界面。使用 Python 和 React.js 构建，它结合了性能、可扩展性和易用性，简化大规模代理管理。此分支将 Xray-core 替换为 [sing-box](https://github.com/SagerNet/sing-box) 以实现最佳性能，同时支持 [WireGuard](https://www.wireguard.com/)。
...
**📖 文档** — sing-box 分支的指南正在开发中

🇺🇸 English | 🇮🇷 فارسی | 🇷🇺 Русский | 🇨🇳 简体中文

</div>

> **原版项目：** [github.com/PasarGuard/panel](https://github.com/PasarGuard/panel) | 原版文档: [docs.pasarguard.org](https://docs.pasarguard.org)
