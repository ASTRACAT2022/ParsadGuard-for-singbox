...
URL="https://github.com/ASTRACAT2022/ParsadGuard-for-singbox/releases/${RELEASE_PATH}/${LANG_CODE}.html"
if [[ "${LANG_CODE}" == "fa" ]]; then
  URL="https://github.com/ASTRACAT2022/ParsadGuard-for-singbox/releases/${RELEASE_PATH}/index.html"
fi
